...
#' you would like to increase in a sequential way
...
SIB_algorithm <- function(factor_level, unit, particle_number, particle_increase,
                          SIB_time, all_two_level, P_w, q_GB, q_LB, q_new,
                          t, total_unit, multiply_len, t_increase,
